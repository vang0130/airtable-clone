...
function SignUpButtons({
  ...
  return (
    <div className="flex h-screen w-screen bg-white">
      <div className="mx-auto max-w-[536.583px] bg-white">
          ...
          <div className="flex w-full flex-col items-center px-5 md:px-0">
            ...
            <form className="flex w-full flex-col items-center justify-center">
              <div className="flex w-full flex-col items-center justify-center">
                ...
                <div className="mt-2 flex h-[46px] w-full flex-row items-center justify-start rounded-md border-[2px] border-gray-300 bg-white px-3 py-[1px] focus:outline-none">
            ...
            <div className="flex w-full flex-col items-center justify-center">
              <div className="mb-8 mt-6 w-full text-center sm:mt-8">
                <p className="text-sm text-gray-500">
                  ...
                  <span className="text-sm underline">Terms of Service</span>{" "}
                  and <span className="text-sm underline">Privacy Policy</span>.
                </p>
              </div>
