...
export default function Sheet() {
  ...
  const addHeader = api.header.createMany.useMutation({
    ...
    async onSuccess(createdHeaders, variables, ctx) {
      ...
      console.log("Header mutation started:", {
        createdHeaders: createdHeaders.map((h) => h.id),
        pendingHeaderIds: pendingHeaders[tableData.id]?.headers.map(
          (h) => h.id,
        ),
      });
      ...
      setTableData((prev) => {
        ...
        // Create a clear mapping dictionary
        ...
        // Update all row values with real IDs
