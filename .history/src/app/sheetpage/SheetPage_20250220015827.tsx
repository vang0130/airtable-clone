...
export default function Sheet() {
  ...
  useEffect(() => {
    ...
    const processBatchUpdates = async () => {
      // If already processing or headers are being processed, skip this attempt
      if (processingRef.current || processingHeaders) {
        console.log("Already processing, skipping...");
        return;
      }

      // Check if any headers have temp IDs (haven't been mutated yet)
      ...
      if (!pendingBatch.updates.length && !pendingBatch.newRows.length) {
        return;
      }
