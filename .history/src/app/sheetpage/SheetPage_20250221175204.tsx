...
export default function Sheet() {
  ...
  const updateRowsForNewHeader = (headerPosition: number) => {
    ...
    // Update all existing rows with new header
    const updatedExistingRows = tableData.rows.map((row) => ({
      rowId: row.id,
      values: {
        ...row.values,
    ...
    // Update all pending rows with new header
