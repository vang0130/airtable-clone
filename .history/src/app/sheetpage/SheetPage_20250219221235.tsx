      ...
      void (async () => {
        ...
        try {
          ...
          if (pendingHeadersEntries.length > 0) {
            ...
            // Then, when processing batch updates, ensure we validate ALL existing rows
            if (
              ...
              // Process existing rows to ensure they have all headers
              const allRowUpdates = [
                ...
                // Process new rows (map tempId to rowId)
                ...pendingBatch.newRows.map((row) => ({
                  rowId: row.tempId, // Convert tempId to rowId
                  values: validateHeaders(row.values),
                })),
              ];
