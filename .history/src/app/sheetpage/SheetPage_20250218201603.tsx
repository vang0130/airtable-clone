...
export default function Sheet() {
  ...
  const handleHeaderAdd = () => {
    ...
    setTableData((prev) => {
      ...
      return {
        ...
        rows: [...allRows, ...pendingRows].map((row) => ({
          ...row,
          values: {
            ...row.values,
            [tempId]: "",
  ...
  const handleRowCreate = useCallback(() => {
    ...
    setTableData((prev) => {
      ...
      const pendingHeaders = pendingHeaders[tableData.id]?.headers ?? [];
      const allHeaders = [...prev.headers, ...pendingHeaders];
      ...
      return {
        ...prev,
        headers: allHeaders, // Include pending headers in tableData
