    ...
    onSuccess(newHeaders, variables, ctx) {
      ...
      setPendingHeaders((prev) => {
        const updatedValues = (values: Record<string, string>) => {
          // Get all header IDs that should exist in each row
          ...
          // Add any missing headers with empty values
