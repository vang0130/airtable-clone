    ...
    setTableData((prev) => {
      ...
      return {
        ...
        rows: prev!.rows.map((row) => ({
          ...row,
          values: {
            ...row.values, // Keep ALL existing values
            [tempId.toString()]: "", // Only add new column
          },
        })),
      };
    });
            ...
            rows: prev!.rows.map((row) => ({
              ...
              values: {
                ...
                [createdHeaders[0].id.toString()]:
                  row.values[tempId.toString()] ?? "", // Map temp ID to real ID
              },
            })),
          };
        });
