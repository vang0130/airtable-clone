...
export default function Sheet() {
  ...
  useEffect(() => {
    ...
    // Set timeout to process after inactivity
      ...
      void (async () => {
        ...
        try {
          ...
          if (
            ...
            const [tableIdStr, { tableId, headers }] = pendingHeadersByTable[0] as [
              string,
              { tableId: number; headers: { id: number; name: string }[] }
            ];

            const newHeaders = headers.filter((h: { id: number }) => h.id < 0);
    ...
    }, 2000); // Single timeout after inactivity
