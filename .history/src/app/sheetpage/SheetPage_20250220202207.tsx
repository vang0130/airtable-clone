...
export default function Sheet() {
  ...
  // Add a ref to track if a header mutation was deferred
    ...
    const processBatch = async () => {
      try {
        ...
        if (deferredHeaderMutationRef.current) {
          console.log("Processing deferred header mutation");
          deferredHeaderMutationRef.current = false;
          // Trigger header processing effect
          void processHeaders();
        }
      }
    };
  ...
  // Extract processHeaders to make it available to both effects
  const processHeaders = useCallback(async () => {
    if (!Object.keys(pendingHeaders).length) return;
