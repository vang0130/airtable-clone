...
export default function Sheet() {
  ...
  const batchUpdate = api.row.batchUpdate.useMutation({
    ...
    onSuccess(result, variables) {
      // Don't clear latestCellUpdatesRef here - keep the values
      console.log("Batch update succeeded, preserving optimistic state");
    },
  ...
  const handleCellUpdate = useCallback(
    (
      ...
      // Rest of your existing handleCellUpdate logic...
    },
